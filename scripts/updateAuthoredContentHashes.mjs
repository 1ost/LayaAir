...
for (const [module, exported, kind = "class"] of [
    ...
    ["src/layaAir/flash/display/BitmapData.ts", "bitmapDataDimensions", "function"],
    ...
    ["src/layaAir/flash/display/DisplayObject.ts", "DisplayObjectLoaderInfo", "type"],
    ["src/layaAir/flash/display/DisplayObject.ts", "bindDisplayObjectLoaderInfo", "function"],
    ["src/layaAir/flash/display/DisplayObject.ts", "flashDisplayObjectNativeHost", "function"],
    ["src/layaAir/flash/display/DisplayObject.ts", "isFlashDisplayObject", "function"],
    ["src/layaAir/flash/display/DisplayObject.ts", "unbindDisplayObjectLoaderInfo", "function"],
    ...
    ["src/layaAir/flash/display/Loader.ts", "NativeLoaderImageHost"],
    ...
    ["src/layaAir/flash/display/Loader.ts", "isNativeLoaderImageHost", "function"],
...
Object.assign(utilsCapability, {
    ...
    obligations: [
        ...
        ["src/layaAir/flash/utils/DefinitionRegistry.ts", "getRegisteredDefinitionNames", "function"],
        ["src/layaAir/flash/utils/DefinitionRegistry.ts", "hasDefinitionByName", "function"],
...
ensureFlashCapability("api.flash.system", [
    ...
    ["src/layaAir/flash/system/LoaderContext.ts", "NativeLoaderContextSnapshot", "interface"],
    ["src/layaAir/flash/system/LoaderContext.ts", "isFlashLoaderContext", "function"],
    ["src/layaAir/flash/system/LoaderContext.ts", "snapshotNativeLoaderContext", "function"],
...
ensureFlashCapability("api.flash.media", [
    ...
    ["src/layaAir/flash/media/Sound.ts", "isFlashSound", "function"],
    ["src/layaAir/flash/media/SoundChannel.ts", "SoundChannel", "class"],
    ["src/layaAir/flash/media/SoundChannel.ts", "createFlashSoundChannel", "function"],
    ["src/layaAir/flash/media/SoundChannel.ts", "isFlashSoundChannel", "function"],
    ["src/layaAir/flash/media/SoundLoaderContext.ts", "SoundLoaderContext", "class"],
    ["src/layaAir/flash/media/SoundLoaderContext.ts", "isFlashSoundLoaderContext", "function"],
    ["src/layaAir/flash/media/SoundTransform.ts", "SoundTransform", "class"],
    ["src/layaAir/flash/media/SoundTransform.ts", "isFlashSoundTransform", "function"],
