...
text.static-glyph-runs text.dynamic text.input text.html-layout text.advanced-rasterization text.authored-device-field-configuration text.authored-static-text-texture-foundation text.authored-font-registry text.authored-embedded-ttf-dynamic-field text.authored-restricted-html-field
...
api.flash.display api.flash.events api.flash.geom api.flash.text api.flash.media api.flash.net api.flash.utils api.flash.filters api.flash.ui api.flash.desktop api.flash.accessibility api.flash.browser api.flash.debug
`.trim().split(/\s+/));
...
const REQUIRED_FLASH_NAMESPACES = ["flash.display", "flash.events", "flash.geom", "flash.text", "flash.media", "flash.net", "flash.utils", "flash.filters", "flash.ui", "flash.desktop", "flash.accessibility", "flash.browser", "flash.debug"];
...
const ADMITTED_BITMAP_FILTER_SUBCLASSES = new Set([
    ...
    "src/layaAir/flash/filters/GradientGlowFilter.ts",
]);
