...
api.flash.display api.flash.events api.flash.geom api.flash.text api.flash.net api.flash.utils api.flash.filters api.flash.ui api.flash.browser
`.trim().split(/\s+/));
...
const REQUIRED_FLASH_NAMESPACES = ["flash.display", "flash.events", "flash.geom", "flash.text", "flash.net", "flash.utils", "flash.filters", "flash.ui", "flash.browser"];
