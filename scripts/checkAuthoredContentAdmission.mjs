...
api.flash.display api.flash.events api.flash.text api.flash.net api.flash.utils
`.trim().split(/\s+/));
...
const REQUIRED_FLASH_NAMESPACES = ["flash.display", "flash.events", "flash.text", "flash.net", "flash.utils"];
