...
function fixture() {
    return {
        ...
        resources: new Map([["assets/1.png", { sourcePath: "assets/1.png", mediaType: "image/png", byteLength: 3265, sha256: "e5bbb339a224febb1ca67486bd0d8943ccaeb153ca385e3c58554e925152f12f" }]]),
    };
}
...
process.stdout.write("authored projected bitmap fill: 5/5 passed\n");
